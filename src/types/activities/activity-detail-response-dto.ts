...
export type ActivityDetailResponseDtoStatus = typeof ActivityDetailResponseDtoStatus[keyof typeof ActivityDetailResponseDtoStatus];
export const ActivityDetailResponseDtoType = {
    Lunch: 'LUNCH',
    Dinner: 'DINNER'
} as const;

export type ActivityDetailResponseDtoType = typeof ActivityDetailResponseDtoType[keyof typeof ActivityDetailResponseDtoType];
