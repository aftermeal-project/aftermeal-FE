...
import { ActivityDetailResponseDtoParticipantsInner } from './activity-detail-response-dto-participants-inner';
...
export interface ActivityDetailResponseDto {
  ...
  /**
   *
   * @type {Array<ActivityDetailResponseDtoParticipantsInner>}
   * @memberof ActivityDetailResponseDto
   */
  participants: Array<ActivityDetailResponseDtoParticipantsInner>;
}
